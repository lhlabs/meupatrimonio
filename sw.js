const CACHE='meu-patrimonio-v9';
const FILES=['./','./index.html','./styles.css','./app.js','./enhancements.js','./integrity.js','./finance-v3.js','./firebase-config.js','./manifest.webmanifest','./icon.svg'];
