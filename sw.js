const CACHE='meu-patrimonio-v12';
const FILES=['./','./index.html','./styles.css','./app.js','./finance-core.js','./dashboard-stability.js','./firebase-config.js','./manifest.webmanifest','./icon.svg'];
