const CACHE='meu-patrimonio-v16';
const FILES=['./','./index.html','./styles.css','./app.js','./dashboard-metrics.js','./finance-logic.js','./portfolio.js','./firebase-config.js','./manifest.webmanifest','./icon.svg'];
