const CACHE='meu-patrimonio-v26';
const FILES=['./','./index.html','./styles.css','./styles.base.css','./app.js','./dashboard-metrics.js','./finance-logic.js','./firebase-config.js','./manifest.webmanifest','./icon.svg'];
